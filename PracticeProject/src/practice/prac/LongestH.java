 ...
 * Output: 0
 */
public class LongestH {
    public static void main(String[] args) {
        System.out.println(getLongestSubseq(new int[]{1, 3, 2, 2, 5, 2, 3, 7}));
        System.out.println(getLongestSubseq(new int[]{1, 2, 3, 4}));
        System.out.println(getLongestSubseq(new int[]{1, 1, 1, 1}));
    }

    public static int getLongestSubseq(int[] nums) {
