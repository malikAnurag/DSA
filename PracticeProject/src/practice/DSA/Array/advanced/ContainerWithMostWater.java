 ...
 * the two endpoints of the line i is at (i, ai) and (i, 0). Find two lines, which, together with the x-axis forms a container, such that the
...
public class ContainerWithMostWater {
    ...
    public static void main(String[] args) {
        System.out.println(getContainerWithMostWater(new int[]{1, 8, 6, 2, 5, 4, 8, 3, 7}));
        System.out.println(getContainerWithMostWater(new int[]{1, 1}));
        System.out.println(getContainerWithMostWater(new int[]{4, 3, 2, 1, 4}));
        System.out.println(getContainerWithMostWater(new int[]{1, 2, 1}));
    }
