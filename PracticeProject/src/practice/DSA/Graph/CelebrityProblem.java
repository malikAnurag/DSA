 ...
 * "Hi, A. Do you know B?" to get information about whether A knows B. You need to find out the celebrity (or verify there is not one) by asking as
 ...
 * Output: 1
 * Explanation: There are three persons labeled with 0, 1 and 2. graph[i][j] = 1 means person i knows person j, otherwise graph[i][j] = 0 means person i
...
public class CelebrityProblem {
    ...
    /*
    * Iterate over all the persons at the party and then iterate again over all the remaining persons to find out the celeb.
