 ...
 * For ans[i] == -1, It can be shown that there is no building where Alice and Bob can meet.
 */
public class FindBuildingWhereAliceAndBob {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(findBuilding(new int[]{6, 4, 8, 5, 2, 7}, new int[][]{{0, 1}, {0, 3}, {2, 4}, {3, 4}, {2, 2}})));
        System.out.println(Arrays.toString(findBuilding(new int[]{5, 3, 8, 2, 6, 1, 4, 6}, new int[][]{{0, 7}, {3, 5}, {5, 2}, {3, 0}, {1, 6}})));
    }

    private static int[] findBuilding(int[] heights, int[][] queries) {
