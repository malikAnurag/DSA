...
public class GoodWaysToSplit {
    ...
    public static void main(String[] args) {
        System.out.println(getNumberOfWays("aacaba"));
        System.out.println(getNumberOfWays("abcd"));
        System.out.println(getNumberOfWays("aaaaa"));
        System.out.println(getNumberOfWays("acbadbaada"));
    }

    public static int getNumberOfWays(String str) {
