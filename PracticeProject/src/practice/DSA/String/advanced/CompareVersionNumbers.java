 ...
 * with the leftmost revision being revision 0, the next revision
 ...
 * at an index, then treat the revision as 0.
 * For example, version 1.0 is less than version 1.1 because their revision 0s are the same, but their revision
...
public class CompareVersionNumbers {
    ...
    public static int compareVersions(String version1, String version2) {
        ...
        for(int i = 0; i < Math.max(n1, n2); i++) {
            ...
            i1 = i < n1 ? Integer.parseInt(str1[i]) : 0;
            i2 = i < n2 ? Integer.parseInt(str2[i]) : 0;
