package edu.coursera.parallel.ReciprocalArraySum;
...
//        //calculate the left half
        ...
        // This is like Async, in parallel, it creates a task to compute left part of the array that further will be subdivided
//        leftHalfTask.fork();
//
...
//        leftHalfTask.join();
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        // triggering the execution of all the tasks in the loop
        // join called in a task waits for the finalization of its execution and returns the value returned by the compute() method
