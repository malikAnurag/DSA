package edu.coursera.parallel.StudentAnalytics;
...
//        throw new UnsupportedOperationException();
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
        ...
        return Arrays.stream(studentArray)
                     .parallel()
                     .filter(student -> !student.checkIsCurrent())
                     .collect(Collectors.groupingBy(student -> student.getFirstName(), Collectors.counting()))
                     .entrySet()
                     .stream().parallel()
    ...
    public int countNumberOfFailedStudentsOlderThan20ParallelStream(
        ...
        return (int) Arrays.stream(studentArray)
                        .parallel()
                        .filter(student -> student.getAge() > 20 && student.getGrade() < 65)
                        .filter(student -> !student.checkIsCurrent())
                        .count();
    }
}
